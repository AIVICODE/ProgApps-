...
<body>
    ...
    <script>
        ...
        registerForm.addEventListener('submit', function(event) {
            ...
            console.log('Datos del formulario:', Object.fromEntries(formData)); // Muestra los datos en la consola

            // Lógica para enviar los datos a la API o al servidor...

            // Luego de enviar los datos, puedes redirigir a otra página o mostrar un mensaje
            // window.location.href = 'pagina_exito.html'; // Ejemplo de redirección
        });
    </script>
</body>
</html>
