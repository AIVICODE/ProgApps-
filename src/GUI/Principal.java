...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuParaBorrar = new javax.swing.JMenu();
        ...
        AltaGenero.setText("AltaGenero");
        AltaGenero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AltaGeneroActionPerformed(evt);
            }
        });
        jMenu2.add(AltaGenero);

        jMenuParaBorrar.setText("ParaBorrar");
        jMenuParaBorrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuParaBorrarActionPerformed(evt);
            }
        });
        jMenu2.add(jMenuParaBorrar);
    ...
    private void jMenuParaBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuParaBorrarActionPerformed
       
    }//GEN-LAST:event_jMenuParaBorrarActionPerformed
    ...
    private javax.swing.JMenu jMenuParaBorrar;
